...
import os
from pygame import mixer  # assim é só escrever mixer e nao pygame.mixer

# ASSIM DEVE DAR PARA 1000 MINUTOS MAIS OU MENOS
...
def creditos_janela():  # ECRÃ DOS CRÉDITOS
    # print(f'creditos: {mixer.music.get_volume()}')
    while True:
...
def play():  # ECRÃ DOS NÍVEIS
    # print(f'play {mixer.music.get_volume()}')
...
def play_nivel1():  # ECRÃ DO NÍVEL 1
    ...
    # print(f'nivel1 {mixer.music.get_volume()}')
...
def play_nivel2():
    ...
    # print(f'nivel2 {mixer.music.get_volume()}')
    PLAY_MOUSE_POS = pygame.mouse.get_pos()
    PLAY_BACK = Button(image=None, pos=(100, 50), text_input="BACK", font=get_font(
        40), base_color="olive", hovering_color="gold")
    PLAY_BACK.changeColor(PLAY_MOUSE_POS)
...
def play_nivel3():  # ECRÃ DO JOGO
    ...
    # print(f'nivel3 {mixer.music.get_volume()}')
    PLAY_MOUSE_POS = pygame.mouse.get_pos()
    PLAY_BACK = Button(image=None, pos=(100, 50), text_input="BACK", font=get_font(
        40), base_color="olive", hovering_color="gold")
    PLAY_BACK.changeColor(PLAY_MOUSE_POS)
...
def options():  # ECRÃ DAS OPÇÕES (com as instruções)
    # print(f'options {mixer.music.get_volume()}')
    while True:
...
def menu():  # ECRÃ DO MENU INICIAL
    ...
    # print(f'menu {mixer.music.get_volume()}')
    while True:
